...
3- Put the CQ (with story if it exists) and the top 20 retrieved elements in the placeholder: OntoExtend Script/OntoExtender/Prompting  Techniques/Components/PromptTemplate/DecomposedPromptingLong.py  (Extension step) 
